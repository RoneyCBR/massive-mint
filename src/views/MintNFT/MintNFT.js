                                    ...
                                    if(preview) {
                                        if(preview.data) {
                                            ...
                                            await axios.post(url_nft_metadata, meta).then(async(success) => {
                                                ...
                                                let url_create_nft = process.env.REACT_APP_URL_API+"/nft?type=SINGLE&file_type="+((currentTime > 0) ? 'JPG' : preview.format)
                                ...
                                <Form>
                                    <Container maxWidth='sm'>
                                        <Box>
                                            ...
                                            >
                                                {t('mint_nft.upload_image')}<span style={{color:'#dc3545'}}>*</span>
                                            </Box>
                                            <Box 
                                                sx={{
                                                    fontSize:'14px',
                                        ...
                                        <Box sx={{marginBottom:'2rem'}}>
                                            ...
                                            >
                                                {t('mint_nft.drag_or_choose')}<span style={{color:'#dc3545'}}>*</span>
                                            </Box>
                                            <Box 
                                                sx={{
                                                    fontSize:'14px',
                                        ...
                                        <Box sx={{marginTop:'1rem', marginBottom:'1rem'}}>
                                            <Box component='label' htmlFor='name' sx={{fontSize:'25px'}}>
                                                {t('mint_nft.nft_name')} <span style={{color:'#dc3545'}}>*</span>
                                            </Box>
                                            <TextField
                                                id='name'
                                                type='text'
                                                placeholder={t('mint_nft.nft_name')}
                                                name='name'
                                                value={values.name}
                                            />
                                        ...
                                        <Box sx={{marginBottom:'1rem'}}>
                                            <Box component='label' htmlFor='description' sx={{fontSize:'25px'}}>
                                                {t('mint_nft.description')} <span style={{color:'#dc3545'}}>*</span>
                                            </Box>
                                            <TextArea
                                                id='description'
                                                as='textarea'
                                                placeholder={t('mint_nft.description')}
                                                name='description'
                                    ...
                                    <Container maxWidth='sm' sx={{marginTop:'1rem'}}>
                                        <Box display='flex' justifyContent='center' alignItems='center' sx={{gap:'5px'}}>
                                            <ButtonStyled text={t('mint_nft.create_btn')} />
                                            <ButtonStyled type='button' text={t('mint_nft.cancel_btn')} onClick={cancel} />
                                        </Box>
                                    </Container>
                                    <LoaderModal
                                        text={t('mint_nft.mintig_loader')}
                                        isOpen={isSubmitting}
                                        textColor='#fff'
                                        spinnerColor='#fff'
                                    />
