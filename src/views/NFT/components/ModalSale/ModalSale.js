    ...
    const handleOffer = async() => {
        ...
        if(wethBalance >= parseFloat(""+bid)) {
            ...
            if ((parseFloat(""+bid) - parseFloat(""+wethBalance)) <= parseFloat(data.formatMaticBalance)) {
                ...
                setWethToChange((parseFloat(""+bid) - parseFloat(""+wethBalance)))
            } else {
              setShowBalance(true)
            }
        }
            ...
            >
                ...
                (<><Box sx={{
                    ...
                    <Box sx={{'@media screen and (max-width: 360px)': {
                        ...
                        <center>
                            <h1 style={{textAlign:'center', marginTop:'5px'}}>{ 'Sale' }</h1>
                        </center>
                    </Box>
                ...
                >
                    ...
                    <center style={{color:'#000'}}>
                                    Current price  { parseFloat(""+top).toFixed(2) } WMATIC
                                </center>
